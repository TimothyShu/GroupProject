...
if __name__ == "__main__":
    ...
    dataset = openml.datasets.get_dataset('Diabetes(scikit-learn)')
    ...
    train(X_train, y_train, "models/diabetes", refit=False, hyperparameter_tuning_folds=3, trials=50)
    
    test(X_test, y_test, "models/diabetes")
