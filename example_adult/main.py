...
if __name__ == "__main__":
    ...
    dataset = openml.datasets.get_dataset('adult')
    ...
    train(X_train, y_train, "models/adult", refit=False, hyperparameter_tuning_folds=3, trials=50)
    
    test(X_test, y_test, "models/adult")
