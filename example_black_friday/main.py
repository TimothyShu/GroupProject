...
if __name__ == "__main__":
    ...
    dataset = openml.datasets.get_dataset('black_friday')
    ...
    train(X_train, y_train, "models/black_friday", refit=False, hyperparameter_tuning_folds=3, trials=10)
    
    test(X_test, y_test, "models/black_friday")
